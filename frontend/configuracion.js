...
class Parametros {
  ...
  agregarServicio() {
    ...
    fetch("/api/configuracion/servicio", {
        method: "POST",
        headers: {
  ...
  agregarTecnico() {
    ...
    fetch("/api/configuracion/tecnico", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
    ...
    fetch("/api/configuracion/estado", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
   ...
   agregarMarca() {
    ...
    eliminarItem(item, input){
        ...
        if(input === "servicio"){
            ...
            fetch(`/api/configuracion/servicio/${id}`, {method: "DELETE"})
            .then(async () => {
            ...
            fetch(`/api/configuracion/estado/${id}`, {method: "DELETE"})
            .then(async () => {
            ...
            fetch(`/api/configuracion/tecnico/${id}`, {method: "DELETE"})
            .then(async () => {
            ...
            fetch(`/api/configuracion/marca/${id}`, {method: "DELETE"})
            .then(async () => {
            ...
            fetch(`/api/configuracion/grupo/${id}`, {method: "DELETE"})
            .then(async () => {
    ...
    eliminarItemGrupo (grupo, service){
        ...
        const servicioId = servicioObj.id;
            ...
            fetch(`/api/configuracion/grupo/${grupoId}/servicio/${servicioId}`, {method: "DELETE"})
            .then(async () => {
...
class Modal{
    ...
    confirmarServicios(){
        ...
        fetch(`/api/configuracion/grupo/${grupo.id}/servicios`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
